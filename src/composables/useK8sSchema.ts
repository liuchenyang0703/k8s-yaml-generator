...
export const createDefaultPersistentVolumeClaim = (): PersistentVolumeClaimFormData => ({ metadata: createMetadata('demo-pvc'), accessModes: 'ReadWriteOnce', storageClassName: '', requests: { storage: '10Gi' }, selector: { matchLabels: {}, matchExpressions: [] } })
